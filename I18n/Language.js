export default {
  en: {
    ...
    Home: {
      Button1: "Start",
      ErrMsg1: "The address is incorrect."
    },
    Delegates: {
      Button1: "Confirm",
    ...
    Confirm: {
      Button1: "Execute",
      Msg1: "Is the content correct?",
      Msg2: "Please enter your passphrase.",
      Msg3: "Please enter your second passphrase.",
      Msg4: "Processing takes about ",
      Msg5: " seconds.",
      Msg6: "The fee is ",
      Msg7: "LSK.",
  ...
  ja: {
    ...
    Home: {
      Button1: "Voteを開始する",
      ErrMsg1: "アドレスが正しくないようです。"
    },
    Delegates: {
      Button1: "確認",
      Msg1: "※デリゲート名での検索は無視されます。",
      ErrMsg1: "Vote可能最大数を超えています。",
      ErrMsg2: "Vote対象がありません。",
      ErrMsg3: "デリゲート情報の取得に失敗しました。"
    },
    Confirm: {
      Button1: "実行",
      Msg1: "内容に間違いはありませんか？",
      Msg2: "パスフレーズを入力して下さい。",
      Msg3: "セカンドパスフレーズを入力して下さい。",
      Msg4: "処理には 約",
      Msg5: "秒 かかります。",
      Msg6: "Vote手数料は ",
      Msg7: "LSK です。",
